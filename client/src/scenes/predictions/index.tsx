  ...
  return (
    ...
    >
     <FlexBetween m = "1rem 2.5rem">
      ...
      <Button onClick={() => setIsPredictions(!isPredictions)} sx={{
     ...
     <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <XAxis dataKey="name" tickLine ={false} style={{fontSize : "10px"}}><Label value= "month" offset={-5} position= "insideBottom"></Label></XAxis>
          <YAxis domain={[12000,26000]} axisLine = {{strokeWidth : '0'}} style={{fontSize : "10px"}} tickFormatter={(v) => `$${v}`}><Label value= "Revenue in USD" angle={-90} offset={-5} position="insideLeft"></Label> </YAxis>
          <Tooltip />   
